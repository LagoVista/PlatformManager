...
$coreappdir = "$scriptPath\src\LagoVista.PlatformManager"
$uwpprojectdir = "$scriptPath\src\LagoVista.PlatformManager.UWP"
$uwpprojectfile = "$uwpprojectdir\LagoVista.PlatformManager.UWP.csproj"
